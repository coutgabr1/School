...
#define LED_PIN 6 // LED are connected to D11
//#define LED_PIN 7
#define N_PIXELS 510 // Number of LED 
#define N 100 // Number of samples 
#define fadeDelay 10 // fade amount
#define noiseLevel 12 // Amount of noice we want to chop off 
